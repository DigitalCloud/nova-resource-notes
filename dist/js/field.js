...
Nova.booting(function (Vue, router) {
    Vue.component('note-text', __webpack_require__(15));
    Vue.component('index-note-text', __webpack_require__(18));
    Vue.component('note-item', __webpack_require__(21));
    Vue.component('note-list', __webpack_require__(24));
    Vue.component('notes-wrapper', __webpack_require__(27));
    Vue.component('detail-notes-field', __webpack_require__(33));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_md5__ = __webpack_require__(40);
    ...
    _vm.note
      ? _c("td", {}, [
          _c(
            ...
            {
              staticClass:
                "bg-teal-lightest border-teal text-teal-darkest px-4 py-3 shadow-md mb-2 mt-4 bg-40",
              attrs: { role: "alert" }
            },
            [
              _c("div", { staticClass: "flex items-center" }, [
                _c("img", {
                  staticClass: "rounded-full w-8 h-8 mr-3",
                  attrs: { src: _vm.gravatar }
                }),
                _vm._v(" "),
                _c("p", {
                  staticClass: "font-bold mr-3",
                  domProps: {
                    innerHTML: _vm._s(
          ...
          _vm._v(" "),
          _c("p", {
            staticClass: "text-sm text-right text-info my-2",
            domProps: {
              innerHTML: _vm._s(

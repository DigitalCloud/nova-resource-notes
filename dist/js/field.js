...
Nova.booting(function (Vue, router) {
    Vue.component('note-text', __webpack_require__(16));
    Vue.component('index-note-text', __webpack_require__(19));
    Vue.component('note-item', __webpack_require__(22));
    Vue.component('note-list', __webpack_require__(27));
    Vue.component('notes-wrapper', __webpack_require__(30));
